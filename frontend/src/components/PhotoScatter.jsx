...
const PHOTOS = [
  ...
  { src: "/photos/memory-1.jpg", style: { top: "34%", right: "2%", width: "140px", height: "175px", transform: "rotate(-5deg)" } },
  ...
  { src: "/photos/memory-5.jpg", style: { top: "68%", right: "16%", width: "135px", height: "170px", transform: "rotate(5deg)" } },
